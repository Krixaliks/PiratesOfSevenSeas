 ...
 * [CGMZ] Window Settings for all of the profession scene windows. This will
 * allow you to customize your windows by adding a background image, including
 * scrolling animated parallax as well as changing windowskins, tones, styles,
 * and more.
 *
 * This update also fixes a bug with calling the profession scene without
 * including party-wide professions and only including 1 actor's per-actor
 * professions in the scene call. Previously, this would show party-wide
 * professions anyways, it should now correctly show the given actor's
 * professions.
 *
 * Version 1.6.2
...
CGMZ.Versions["Professions"] = "1.6.2";
CGMZ.Professions = {};
