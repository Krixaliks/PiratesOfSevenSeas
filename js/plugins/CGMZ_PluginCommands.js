 ...
 * rename the js file.
 * --------------------------Latest Version------------------------------------
 * Hi all, this latest version adds some new plugin commands for BGM/BGS.
 *
 * Get BGM Pos - Stores the current BGM position into a variable, in case you
 * want certain effects to happen in time to your BGM.
 *
 * Get BGS Pos - Stores the current BGS position into a variable, in case you
 * want certain effects to happen in time to your BGS.
 *
 * Version 1.5.0
...
CGMZ.Versions["Plugin Commands"] = "1.5.0";
//=============================================================================
// CGMZ
//-----------------------------------------------------------------------------
// Handle saved data
