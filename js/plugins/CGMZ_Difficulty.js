 ...
 * rename the js file.
 * --------------------------Latest Version------------------------------------
 * Hi all, this latest version adds two integrations. The first is [CGMZ]
 * Window Settings which is how you will customize window style, windowskin,
 * window tone, etc. This also allows me to add more window settings without
 * needing to update all of my plugins that have windows. The second is [CGMZ]
 * Window Backgrounds which allows you to add an image including animated
 * scrolling parallax as a window's background.
 *
 * Version 1.3.1
...
CGMZ.Versions["Difficulty"] = "1.3.1";
CGMZ.Difficulty = {};
