 ...
 * rename the js file.
 * -----------------------------Latest Version---------------------------------
 * Hi all, this latest version added two integrations with other [CGMZ] 
 * plugins. You can now show an image as any window's background, including
 * an animated scrolling parallax image via [CGMZ] Window Backgrounds. You
 * can also now change any window's tint, windowskin, background style, and
 * more with [CGMZ] Window Settings.
 *
 * The option to prevent the player from canceling out of the fast travel
 * scene was also added. If using this, you will need to make sure they can
 * always travel to a point or else the player could get stuck in the fast
 * travel scene.
 *
 * Version 1.2.1
...
CGMZ.Versions["Fast Travel"] = "1.2.1";
CGMZ.FastTravel = {};
