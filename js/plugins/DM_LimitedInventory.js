 ...
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 * 
 * ⓘ Flexible Inventory Mechanics: Choose between "Item Weight" or "Slot Based" 
 ...
 * flexibility.
 *
 * ⓘ Customizable Containers: Create and manage containers with adjustable 
 * settings, including but not limited to:
 * 
 * ➢ Weight limits
 * ➢ Item/Weapon/Armor Contents
 * ➢ Display Names and Icons
 *
 * ⓘ Generate Containers In-Game: This feature allows you to create containers 
 ...
 *
 * ⓘ Weight-Based Item Management: Assign weight properties to items, weapons, 
 * and armors using note tags, with support for decimal values.
 *
 * ⓘ Customizable Sound Effects: Set individual sound effects for items, 
 ...
 *
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 * 4.4 🏷️ Note tags for $dataWeapons & $dataArmors
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 * 
 * ───────────────────────────────────────────────────────────────────────────
 * <equipWeight:value>
 ...
 * ───────────────────────────────────────────────────────────────────────────
 * ⓘ Enables or disables the touch UI for item quantity input, allowing for
 ...
 * ➔ This will enable the touch UI Sprite Buttons and add them to the
 * item quantity window.
 * $gameContainers.setItemQuantityTouchUIEnabled(false);
 * ➔ This will disable the touch UI Sprite Buttons and remove them from the
 ...
 *  ➔ Checks to see if the party has room for 6 of armor id 25.
 * $gameContainers.checkPartyHaveSpaceForArmor(32, 100);
 *  ➔ Checks to see if the party has room for 100 of armor id 32.
 *
 * ───────────────────────────────────────────────────────────────────────────
 * $gameContainers.getContainerItemCount(containerId);
 * ───────────────────────────────────────────────────────────────────────────
 * ⓘ containerId : It's a number representing the ID of the container you want 
...
Game_Containers.prototype.putBackContainersContents = function () {
    ...
    for (let i = 0; i < this._storedContainerContents.length; i++) {
        ...
        for (let itemData of containerItems) {
            ...
            // 3) Bulk‐transfer missing units in one go
